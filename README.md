...
# Questão 5
**Resposta:** A estrutura Heap é perfeita para criar "Filas de Prioridade" (Priority Queues). Um exemplo clássico disso em grafos é o **Algoritmo de Dijkstra** (usado para achar caminhos mais curtos, como rotas de GPS). 
